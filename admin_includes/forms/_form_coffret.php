<?php
/*
 * Fichier partiel : _form_coffret.php
 * Rôle : Affiche les champs de formulaire spécifiques à un coffret.
 */
?>
<fieldset class="border p-3 mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" name="description" rows="3"><?php echo htmlspecialchars(isset($produit['description_coffret']) ? $produit['description_coffret'] : ''); ?></textarea>
    </div>
    <div class="row">
